    ...
    <div className="min-h-screen p-6">
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div>
          ...
          <p className="text-gray-400">Manage your wallet and security settings</p>
        </div>
        ...
        <div className="glass-card rounded-2xl p-6 border border-white/10">
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-between items-center py-3 border-b border-white/10">
              ...
              <span className="text-white">{isHDWallet ? 'HD Wallet' : 'Imported'}</span>
            </div>

            <div className="flex justify-between items-center py-3 border-b border-white/10">
              <span className="text-gray-400">Network</span>
              <span className="text-white capitalize">{env.NEXT_PUBLIC_NETWORK}</span>
            </div>
          </div>
        </div>
        ...
        {/* Security & Backup */}
        <div className="glass-card rounded-2xl p-6 border border-white/10">
          <h2 className="text-xl font-semibold text-white mb-4">Security & Backup</h2>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div className="text-left">
                  ...
                  <p className="text-sm text-gray-400">Download your private key</p>
                </div>
              </div>
            ...
            {isHDWallet && (
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-left">
                    <p className="text-white font-medium">Export Recovery Phrase</p>
        ...
        <div className="glass-card rounded-2xl p-6 border border-red-500/30">
          ...
          <button
            ...
            className="w-full flex items-center justify-between p-4 rounded-xl bg-red-500/10 hover:bg-red-500/20 border border-red-500/30 transition-all"
          >
            <div className="flex items-center gap-3">
              ...
              <div className="text-left">
                ...
                <p className="text-sm text-gray-400">Permanently remove this wallet</p>
              </div>
            </div>
            <svg className="w-5 h-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
